...
const rawQuestions = [
  ...
  },
  {
    ...
    learning: {
      ...
      blanks: {
        'pc-blank-ammeter': { id: 'pc-blank-ammeter', answerType: 'single-choice', prompt: '電流計の正しい接続はどれか。', options: [option('pc-ammeter-series', '測定する枝に直列'), option('pc-ammeter-parallel', '抵抗器に並列', '電流計は測りたい電流そのものを通すため直列に接続します。')], correctOptionIds: ['pc-ammeter-series'], knowledgeTags: ['series-parallel'], skillTag: 'condition-reading', explanation: [text('pc-exp-ammeter', '電流計は測定する枝に直列に入れます。')], shortPracticeQuestionId: 'physics-magnetic-01' },
        ...
        'pc-blank-unit': { id: 'pc-blank-unit', answerType: 'single-choice', prompt: '電力の SI 単位はどれか。', options: [option('pc-unit-watt', 'W（ワット）'), option('pc-unit-joule', 'J（ジュール）', 'J はエネルギーの単位です。'), option('pc-unit-ampere', 'A（アンペア）', 'A は電流の単位です。')], correctOptionIds: ['pc-unit-watt'], knowledgeTags: ['electric-power'], skillTag: 'unit', explanation: [text('pc-exp-unit', '電力の単位は W です。')], shortPracticeQuestionId: 'physics-magnetic-01' },
        'pc-final-choice': {
